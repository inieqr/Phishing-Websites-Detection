...
- Decision Tree
- Random Forest
- Artifical Neural Networks (Multilayer Perceptron)

(For this dataset MLP gave the highest accuracy (99%) with suitably balanced precision and recall,the trained model is saved [here](https://github.com/inieqr/Phishing-Websites-Detection/models))


## 👨‍💻 To run (locally)
1. Import this repository using git command
```
git clone https://github.com/inieqr/Phishing-Websites-Detection.git
```
...
- Checkout Official Website : [phishr.vercel.com](https://phishman.vercel.app/)
- Website Repository : [here](https://github.com/inieqr/PHISHMAN)
- Rest API documentation - [here](https://phishman-api.onrender.com/docs) 


### Related Repositories
- Rest API deployment repository - [here](https://github.com/inieqr/Phishman-API) 
- React Web Interface repository - [here](https://github.com/inieqr/PHISHMAN)
##
